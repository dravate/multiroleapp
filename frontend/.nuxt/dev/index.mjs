...
import { dirname as dirname$1, resolve as resolve$1, basename, isAbsolute } from 'file:///app/node_modules/pathe/dist/index.mjs';
...
import localAdapter from 'file:///app/node_modules/db0/dist/connectors/better-sqlite3.mjs';
...
const _inlineRuntimeConfig = {
  ...
  "content": {
    ...
    "localDatabase": {
      "type": "sqlite",
      "filename": "/app/.data/content/contents.sqlite"
    },
    "integrityCheck": true
  },
  "ipx": {
...
const _M7kJVD = eventHandler(async (event) => {
  ...
  return await import('file:///app/.nuxt/content/database.compressed.mjs').then((m) => m[collection]);
});
...
const _dVEzSp = eventHandler(async (event) => {
...
const _t4hXU7 = lazyEventHandler(() => {
...
const handlers = [
  ...
  { route: '/__nuxt_content/:collection/sql_dump.txt', handler: _M7kJVD, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_content/:collection/query', handler: _dVEzSp, lazy: false, middleware: false, method: undefined },
  { route: '/_ipx/**', handler: _t4hXU7, lazy: false, middleware: false, method: undefined },
  { route: '/_fonts/**', handler: _lazy_qh6Orl, lazy: true, middleware: false, method: undefined },
